...
export const onBoardCSS = css`
  :root {
    ...
    // font families
    --onboard-font-family-normal: ${({ theme: { fonts } }) => fonts.family};
    --onboard-font-family-semibold: ${({ theme: { fonts } }) => fonts.family};
    --onboard-font-family-light: ${({ theme: { fonts } }) => fonts.family};
    --account-select-modal-font-family-normal: ${({ theme: { fonts } }) => fonts.family};
    --account-select-modal-font-family-light: ${({ theme: { fonts } }) => fonts.family};
...
export const ModalCSS = `
  .fixed .flex .modal-overflow {
    overflow: visible;
  }

  .fixed .modal-overflow .modal {
  ...
  /* Notice */
  .fixed .modal .content .wallets-container .notice-container .container {
    background: rgba(255, 255, 255, 0.8);
    border-color: var(--onboard-connect-sidebar-border-color);
    color: #000;
    font-size: 13px;
    font-weight: 600;
    line-height: 1.2;
  ...
  .fixed .modal .content .wallets-container .notice-container .container a {
    color: #000;
    display: inline-flex;
    font-size: 12px;
    font-style: italic;
