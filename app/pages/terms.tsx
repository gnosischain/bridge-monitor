...
const TermsPage: NextPage = () => {
  const title = 'Terms and Conditions - Gnosis Bridge Explorer'
  ...
  return (
    <>
      ...
      <Wrapper>
        <Title>TERMS AND CONDITIONS ("TERMS")</Title>
        <Paragraph>
          <b>Last updated: DATE</b>
        </Paragraph>
        <Paragraph>
          Please read these terms and conditions carefully before accessing or using our website{' '}
          <a href="https://gnosis.io">https://gnosis.io</a> (the "Site"). Lorem ipsum dolor sit
          amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
          dolore magna aliquyam erat, sed diam voluptua.
        </Paragraph>
        <BaseSubTitle>TERMS AND CONDITIONS ("TERMS")</BaseSubTitle>
        <EmphasizedTitle>1. WHO WE ARE</EmphasizedTitle>
        <Paragraph>
        ...
        <EmphasizedTitle>2. BY USING OUR SITE, YOU ACCEPT THESE TERMS</EmphasizedTitle>
        <Paragraph>
          2.1. These terms and conditions ("Terms") lorem ipsum dolor sit amet, consetetur
        ...
        <Paragraph>
          2.2. Currently, we maintain <a href="https://gnosis.io">https://gnosis.io</a> lorem ipsum
          dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
          labore et dolore magna aliquyam erat, sed diam voluptua.
        </Paragraph>
        <EmphasizedTitle>3. ACCESS TO OUR SITE</EmphasizedTitle>
        <Paragraph>
          3.1. Access to our site lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
