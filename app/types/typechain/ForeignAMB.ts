...
export interface ForeignAMBInterface extends utils.Interface {
  functions: {
    ...
    'safeExecuteSignaturesWithGasLimit(bytes,bytes,uint32)': FunctionFragment
    'safeExecuteSignatures(bytes,bytes)': FunctionFragment
  ...
  decodeFunctionResult(functionFragment: 'safeExecuteSignatures', data: BytesLike): Result
