...
import type { HomeAMB, HomeAMBInterface } from '../HomeAMB'
...
export class HomeAMB__factory {
  static readonly abi = _abi
  static createInterface(): HomeAMBInterface {
    return new utils.Interface(_abi) as HomeAMBInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): HomeAMB {
    return new Contract(address, _abi, signerOrProvider) as HomeAMB
  }
}
