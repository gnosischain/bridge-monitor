...
import type {
  ...
  ForeignBridgeErcToNativeInterface,
} from '../ForeignBridgeErcToNative'
...
export class ForeignBridgeErcToNative__factory {
  static readonly abi = _abi
  static createInterface(): ForeignBridgeErcToNativeInterface {
    return new utils.Interface(_abi) as ForeignBridgeErcToNativeInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ForeignBridgeErcToNative {
    return new Contract(address, _abi, signerOrProvider) as ForeignBridgeErcToNative
  }
}
