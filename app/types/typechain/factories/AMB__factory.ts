...
import type { AMB, AMBInterface } from '../AMB'
...
export class AMB__factory {
  static readonly abi = _abi
  static createInterface(): AMBInterface {
    return new utils.Interface(_abi) as AMBInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AMB {
    return new Contract(address, _abi, signerOrProvider) as AMB
  }
}
