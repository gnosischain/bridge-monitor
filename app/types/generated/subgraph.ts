...
type TransactionFragment_AmbTransaction_Fragment = {
  __typename?: 'AMBTransaction'
  id: string
  bridgeName?: string | null
  transactionHash?: any | null
  initiator?: any | null
  initiatorAmount?: any | null
  initiatorNetwork?: string | null
  initiatorToken?: any | null
  receiver?: any | null
  receiverToken?: any | null
  receiverAmount?: any | null
  receiverNetwork?: string | null
...
type TransactionFragment_XdaiTransaction_Fragment = {
  __typename?: 'XDAITransaction'
  id: string
  bridgeName?: string | null
  transactionHash?: any | null
...
export type TransactionFragmentFragment =
  | TransactionFragment_AmbTransaction_Fragment
  | TransactionFragment_XdaiTransaction_Fragment
...
export type ValidatorsQuery = {
  ...
  validators: Array<{
    ...
    signed: Array<{ __typename?: 'TransactionValidation'; id: string }>
    executed: Array<{ __typename?: 'TransactionExecution'; id: string }>
  }>
}
...
export function getSdkWithHooks(
  ...
  return {
    ...
    useTransactions(
      variables?: TransactionsQueryVariables,
      config?: SWRConfigInterface<TransactionsQuery, ClientError>,
    ) {
      return useSWR<TransactionsQuery, ClientError>(
        genKey<TransactionsQueryVariables>('Transactions', variables),
        () => sdk.Transactions(variables),
        config,
      )
    },
    useValidators(
      variables?: ValidatorsQueryVariables,
      config?: SWRConfigInterface<ValidatorsQuery, ClientError>,
    ) {
      return useSWR<ValidatorsQuery, ClientError>(
        genKey<ValidatorsQueryVariables>('Validators', variables),
        () => sdk.Validators(variables),
        config,
      )
    },
  }
